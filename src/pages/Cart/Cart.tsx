    ...
    setExtendedPurchases((prev) => {
      ...
      return (
        purchasesInCart?.map((purchase) => {
          const isChoosenPurChaseeFromLocation = choosenPurchaseIdFromLocation === purchase._id
          return {
            ...purchase,
            disabled: false,
            checked: isChoosenPurChaseeFromLocation || Boolean(extendedPurchaseObject[purchase._id]?.checked)
          }
        }) || []
      )
    })
        ...
        {extendedPurchases.length > 0 ? (
          ...
          <div className='text-center'>
            ...
            <div className='mt-5 text-center'>
              <Link
                to={path.home}
                className='transitions-all rounded-sm bg-orange px-10 py-2 uppercase text-white hover:bg-orange/80'
              >
                Mua ngay
              </Link>
            </div>
